...
tabContainer.addEventListener('click', function (e) {
    ...
    const removeClass = function (selectors, className) {
        selectors.forEach(el => el.classList.remove(className));
    }

    removeClass(tabs, 'operations__tab--active');
    removeClass(tabsContent, 'operations__content--active');
